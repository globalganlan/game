...
- `specs/combat-power.md` — 戰力計算（排行榜顯示、匹配參考）
- `specs/core-combat.md` — 戰鬥引擎（挑戰戰鬥）
- `specs/hero-schema.md` — 英雄數值
- `specs/save-system.md` — 防守陣型存檔
- `specs/stage-system.md` — 現有 PvP 場景主題可復用
- `specs/auth-system.md` — 玩家身份
- `specs/inventory.md` — 競技幣道具
