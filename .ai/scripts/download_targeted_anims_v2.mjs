/**
 * download_targeted_anims_v2.mjs — 第二輪目標動畫替換
 * 用法: node .ai/scripts/download_targeted_anims_v2.mjs
 */
import fs from 'fs';
...
const REPLACEMENTS = [
  // z7 屍警 — attack: DaggerStab（刺擊，較少頭部旋轉）
  { hero: 'zombie_7',  type: 'attack', modelId: 102700901, label: 'Double Dagger Stab' },
  // z7 屍警 — run: RunningLeaning（更直立的跑姿）
  { hero: 'zombie_7',  type: 'run',    modelId: 105940901, label: 'Running Leaning' },
  // z8 怨武者 — attack: BayonetSlash（揮砍，符合武者風格）
  { hero: 'zombie_8',  type: 'attack', modelId: 104820901, label: 'Bayonet Slash' },
  // z16 荒拳鬥士 — attack: ZombieRightHand（右手攻擊=右手斧揮砍）
  { hero: 'zombie_16', type: 'attack', modelId: 102320902, label: 'Zombie Attack With Right Hand' },
  // z16 荒拳鬥士 — idle: ZombieTwitch（殭屍抽搐，更適合持斧姿態）
  { hero: 'zombie_16', type: 'idle',   modelId: 104110901, label: 'Zombie Twitching Idle' },
  // z19 星蝕者 — attack: Roar（怒吼，頭向上非向下）
  { hero: 'zombie_19', type: 'attack', modelId: 112900901, label: 'Belting Out A Loud Roar' },
  // z20 鏽鋼衛士 — attack: ElbowUppercut（肘擊上鉤，節奏適中）
  { hero: 'zombie_20', type: 'attack', modelId: 113920901, label: 'Elbow-Uppercut Strike Combo' },
  // z25 骸骨騎士 — run: RunningLeaning（直立跑姿）
  { hero: 'zombie_25', type: 'run',    modelId: 105940901, label: 'Running Leaning' },
  // z26 老魔獵人 — run: RunningLeaning（直立跑姿）
  { hero: 'zombie_26', type: 'run',    modelId: 105940901, label: 'Running Leaning' },
  // z28 末日歌姬 — run: RunningLeaning（直立跑姿）
  { hero: 'zombie_28', type: 'run',    modelId: 105940901, label: 'Running Leaning' },
];
...
async function main() {
  ...
  console.log(`\n🏃 第二輪目標動畫替換 — ${REPLACEMENTS.length} 個動畫\n`);
