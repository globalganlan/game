...
- `.ai/specs/core-combat.md` — 戰鬥引擎
- `.ai/specs/hero-schema.md` — 英雄數值（ZOMBIE_IDS [1-14]）
- `.ai/specs/save-system.md` — 進度儲存（storyProgress / towerFloor / stageStars，stageStars 值為 `1` 表示已通關）
...
| `.ai/scripts/seed_stage_configs.sql` | D1 種子資料 — 64 筆關卡配置 |
