...
- `.ai/specs/ui-flow.md` — GameState 控制顯示時機
- `.ai/specs/inventory.md` — ItemDefinition（道具名稱/稀有度/icon）
- `.ai/specs/hero-schema.md` — RawHeroData（英雄名稱/稀有度/大頭照）
- `.ai/specs/progression.md` — OwnedEquipment / EquipmentTemplate（裝備名稱/套裝/稀有度）
- `.ai/specs/gacha.md` — 抽卡結果
- `.ai/specs/stage-system.md` — 通關獎勵
- `.ai/specs/combat-power.md` — CurrencyIcon 元件復用
