...
- `.ai/specs/hero-schema.md` — BattleHero / FinalStats 數值
- `.ai/specs/progression.md` — getFinalStats（含等級/突破/星級/裝備/套裝加成）
- `.ai/specs/skill-system.md` — 被動技能效果加權
- `.ai/specs/save-system.md` — formation 陣型、hero_instances、equipment
- `.ai/specs/ui-flow.md` — GameState / MenuScreen 控制顯示時機
- `.ai/specs/element-system.md` — 屬性權重（選配）
